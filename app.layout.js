...
function downloadLayoutSrc() {
    ...
    t.find(".preview, .configuration, .drag, .remove").remove(), t.find(".lyrow").addClass("removeClean"), t.find(".box-element").addClass("removeClean"), t.find(".lyrow .lyrow .lyrow .lyrow .lyrow .removeClean").each(function() {
        ...
        cleanHtml(this)
    }), t.find(".removeClean").remove(), $("#download-layout .column").removeClass("ui-sortable"), t.find(".column").removeClass("column"), $("#download-layout .container").length > 0 && changeStructure("row-fluid", "row"), formatSrc = $.htmlClean($("#download-layout").html(), {
        format: !0,
        allowedAttributes: [
            ["id"],
            ["class"],
...
if (! function(t, e) {
        ...
        function D(t, e, i, n, s) {
            for (var o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, a = 0; 4 > o; o += 2) "margin" === i && (a += Z.css(t, i + xt[o], !0, s)), n ? ("content" === i && (a -= Z.css(t, "padding" + xt[o], !0, s)), "margin" !== i && (a -= Z.css(t, "border" + xt[o] + "Width", !0, s))) : (a += Z.css(t, "padding" + xt[o], !0, s), "padding" !== i && (a += Z.css(t, "border" + xt[o] + "Width", !0, s)));
            return a
        }
        ...
        function T(t, e, i) {
            ...
            if (0 >= s || null == s) {
                if (s = w(t, e, o), (0 > s || null == s) && (s = t.style[e]), Lt.test(s)) return s;
        ...
        function I(t, e) {
            for (var i, n, s, o = [], a = 0, r = t.length; r > a; a++) n = t[a], n.style && (o[a] = vt.get(n, "olddisplay"), i = n.style.display, e ? (o[a] || "none" !== i || (n.style.display = ""), "" === n.style.display && Ct(n) && (o[a] = vt.access(n, "olddisplay", _(n.nodeName)))) : (s = Ct(n), "none" === i && s || vt.set(n, "olddisplay", s ? i : Z.css(n, "display"))));
        ...
        function P(t, e, i) {
            ...
            if (Z.isEmptyObject(d)) "inline" === ("none" === h ? _(t.nodeName) : h) && (p.display = h);
                ...
                for (n in d) a = N(f ? m[n] : 0, n, u), n in m || (m[n] = a.start, f && (a.end = a.start, a.start = "width" === n || "height" === n ? 1 : 0))
            }
        }
        ...
        function H(t, e, i) {
            var n, s, o = 0,
                ...
                l = function() {
                    if (s) return !1;
                    for (var e = Gt || E(), i = Math.max(0, h.startTime + h.duration - e), n = i / h.duration || 0, o = 1 - n, a = 0, l = h.tweens.length; l > a; a++) h.tweens[a].run(o);
            ...
            return Z.map(c, N, h), Z.isFunction(h.opts.start) && h.opts.start.call(t, h), Z.fx.timer(Z.extend(l, {
                elem: t,
                anim: h,
                queue: h.opts.queue
        ...
        Z.fn = Z.prototype = {
            ...
            for ("boolean" == typeof a && (h = a, a = arguments[r] || {}, r++), "object" == typeof a || Z.isFunction(a) || (a = {}), r === l && (a = this, r--); l > r; r++)
                if (null != (t = arguments[r]))
                    for (e in t) i = a[e], n = t[e], a !== n && (h && n && (Z.isPlainObject(n) || (s = Z.isArray(n))) ? (s ? (s = !1, o = i && Z.isArray(i) ? i : []) : o = i && Z.isPlainObject(i) ? i : {}, a[e] = Z.extend(h, o, n)) : void 0 !== n && (a[e] = n));
            return a
        }, Z.extend({
        ...
        var st = function(t) {
            function e(t, e, i, n) {
                ...
                if ((e ? e.ownerDocument || e : F) !== P && N(e), e = e || P, i = i || [], r = e.nodeType, "string" != typeof t || !t || 1 !== r && 9 !== r && 11 !== r) return i;
                if (!n && H) {
                    if (11 !== r && (s = bt.exec(t)))
                        if (a = s[1]) {
                            if (9 === r) {
                            ...
                            if ((a = s[3]) && w.getElementsByClassName) return J.apply(i, e.getElementsByClassName(a)), i
                        }
                    if (w.qsa && (!O || !O.test(t))) {
            ...
            function p(t, e, i) {
                ...
                return e.first ? function(e, i, o) {
                    ...
                    if (a) {
                        ...
                        for (; e = e[n];)
                            if (1 === e.nodeType || s) {
                                if (l = e[R] || (e[R] = {}), (r = l[n]) && r[0] === j && r[1] === o) return h[2] = r[2];
            ...
            function v(t, e, i, s, o, a) {
                return s && !s[R] && (s = v(s)), o && !o[R] && (o = v(o, a)), n(function(n, a, r, l) {
                    var h, c, u, d = [],
                        ...
                        y = i ? o || (n ? t : f || s) ? [] : a : b;
                    if (i && i(b, y, r, l), s)
                        for (h = g(y, p), s(h, [], r, l), c = h.length; c--;)(u = h[c]) && (y[p[c]] = !(b[p[c]] = u));
                    if (n) {
                        if (o || t) {
                            if (o) {
            ...
            w = e.support = {}, k = e.isXML = function(t) {
                ...
                if ((t.ownerDocument || t) !== P && N(t), i = i.replace(ut, "='$1']"), !(!w.matchesSelector || !H || $ && $.test(i) || O && O.test(i))) try {
                    var n = z.call(t, i);
                    ...
                    CHILD: function(t, e, i, n, s) {
                        ...
                        return 1 === n && 0 === s ? function(t) {
                            ...
                            if (g) {
                                ...
                                } else if (b && (h = (e[R] || (e[R] = {}))[t]) && h[0] === j) d = h[1];
                                else
                                    for (;
                                        (u = ++p && u && u[m] || (d = p = 0) || f.pop()) && ((r ? u.nodeName.toLowerCase() !== v : 1 !== u.nodeType) || !++d || (b && ((u[R] || (u[R] = {}))[t] = [j, d]), u !== e)););
            ...
            return u.prototype = x.filters = x.pseudos, x.setFilters = new u, D = e.tokenize = function(t, i) {
                ...
                var i, n = [],
                    ...
                    o = Y[t + " "];
                if (!o) {
                    for (e || (e = D(t)), i = e.length; i--;) o = b(e[i]), o[R] ? n.push(o) : s.push(o);
        ...
        Z.Callbacks = function(t) {
                ...
                u = {
                    ...
                    remove: function() {
                        return l && Z.each(arguments, function(t, e) {
                            for (var i;
                                (i = Z.inArray(e, l, i)) > -1;) l.splice(i, 1), n && (a >= i && a--, r >= i && r--)
                        }), this
                    },
                    has: function(t) {
            ...
            when: function(t) {
                ...
                if (a > 1)
                    for (e = new Array(a), i = new Array(a), n = new Array(a); a > s; s++) o[s] && Z.isFunction(o[s].promise) ? o[s].promise().done(h(s, n, o)).fail(l.reject).progress(h(s, i, e)) : --r;
        ...
        var gt = Z.access = function(t, e, i, n, s, o, a) {
            ...
            if ("object" === Z.type(i)) {
                s = !0;
                for (r in i) Z.access(t, e, r, i[r], !0, o, a)
            ...
            data: function(t, e) {
                ...
                if (void 0 === t) {
                    if (this.length && (s = bt.get(o), 1 === o.nodeType && !vt.get(o, "hasDataAttrs"))) {
                        for (i = a.length; i--;) a[i] && (n = a[i].name, 0 === n.indexOf("data-") && (n = Z.camelCase(n.slice(5)), l(o, n, s[n])));
        ...
        Z.event = {
            ...
            add: function(t, e, i, n, s) {
                ...
                if (g)
                    for (i.handler && (o = i, i = o.handler, s = o.selector), i.guid || (i.guid = Z.guid++), (l = g.events) || (l = g.events = {}), (a = g.handle) || (a = g.handle = function(e) {
                        ...
                        }), e = (e || "").match(pt) || [""], h = e.length; h--;) r = Et.exec(e[h]) || [], p = m = r[1], f = (r[2] || "").split(".").sort(), p && (u = Z.event.special[p] || {}, p = (s ? u.delegateType : u.bindType) || p, u = Z.event.special[p] || {}, c = Z.extend({
                        type: p,
                        origType: m,
                        data: n,
                        handler: i,
                        ...
                        namespace: f.join(".")
                    }, o), (d = l[p]) || (d = l[p] = [], d.delegateCount = 0, u.setup && u.setup.call(t, n, f, a) !== !1 || t.addEventListener && t.addEventListener(p, a, !1)), u.add && (u.add.call(t, c), c.handler.guid || (c.handler.guid = i.guid)), s ? d.splice(d.delegateCount++, 0, c) : d.push(c), Z.event.global[p] = !0)
            },
                ...
                if (g && (l = g.events)) {
                    for (e = (e || "").match(pt) || [""], h = e.length; h--;)
                        if (r = Et.exec(e[h]) || [], p = m = r[1], f = (r[2] || "").split(".").sort(), p) {
                            for (u = Z.event.special[p] || {}, p = (n ? u.delegateType : u.bindType) || p, d = l[p] || [], r = r[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = d.length; o--;) c = d[o], !s && m !== c.origType || i && i.guid !== c.guid || r && !r.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (d.splice(o, 1), c.selector && d.delegateCount--, u.remove && u.remove.call(t, c));
            ...
            trigger: function(e, i, n, s) {
                ...
                if (a = r = n = n || Q, 3 !== n.nodeType && 8 !== n.nodeType && !St.test(p + Z.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), h = p.indexOf(":") < 0 && "on" + p, e = e[Z.expando] ? e : new Z.Event(p, "object" == typeof e && e), e.isTrigger = s ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : Z.makeArray(i, [e]), u = Z.event.special[p] || {}, s || !u.trigger || u.trigger.apply(n, i) !== !1)) {
                    if (!s && !u.noBubble && !Z.isWindow(n)) {
                        for (l = u.delegateType || p, St.test(l + p) || (a = a.parentNode); a; a = a.parentNode) d.push(a), r = a;
                        r === (n.ownerDocument || Q) && d.push(r.defaultView || r.parentWindow || t)
                    }
                    for (o = 0;
                        (a = d[o++]) && !e.isPropagationStopped();) e.type = o > 1 ? l : u.bindType || p, c = (vt.get(a, "events") || {})[e.type] && vt.get(a, "handle"), c && c.apply(a, i), c = h && a[h], c && c.apply && Z.acceptData(a) && (e.result = c.apply(a, i), e.result === !1 && e.preventDefault());
                ...
                if (r[0] = t, t.delegateTarget = this, !h.preDispatch || h.preDispatch.call(this, t) !== !1) {
                    for (a = Z.event.handlers.call(this, t, l), e = 0;
                        ...
                        for (t.currentTarget = s.elem, i = 0;
                            (o = s.handlers[i++]) && !t.isImmediatePropagationStopped();)(!t.namespace_re || t.namespace_re.test(o.namespace)) && (t.handleObj = o, t.data = o.data, n = ((Z.event.special[o.origType] || {}).handle || o.handler).apply(s.elem, r), void 0 !== n && (t.result = n) === !1 && (t.preventDefault(), t.stopPropagation()));
                ...
                if (r && l.nodeType && (!t.button || "click" !== t.type))
                    for (; l !== this; l = l.parentNode || this)
                        if (l.disabled !== !0 || "click" !== t.type) {
                            for (n = [], i = 0; r > i; i++) o = e[i], s = o.selector + " ", void 0 === n[s] && (n[s] = o.needsContext ? Z(s, this).index(l) >= 0 : Z.find(s, this, null, [l]).length), n[s] && n.push(o);
                            n.length && a.push({
                                elem: l,
                                handlers: n
                            })
            ...
            fix: function(t) {
                ...
                var e, i, n, s = t.type,
                    o = t,
                    a = this.fixHooks[s];
                for (a || (this.fixHooks[s] = a = It.test(s) ? this.mouseHooks : Tt.test(s) ? this.keyHooks : {}), n = a.props ? this.props.concat(a.props) : this.props, t = new Z.Event(o), e = n.length; e--;) i = n[e], t[i] = o[i];
        ...
        Wt.optgroup = Wt.option, Wt.tbody = Wt.tfoot = Wt.colgroup = Wt.caption = Wt.thead, Wt.th = Wt.td, Z.extend({
            clone: function(t, e, i) {
                ...
                if (!(G.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || Z.isXMLDoc(t)))
                    for (a = v(r), o = v(t), n = 0, s = o.length; s > n; n++) b(o[n], a[n]);
                if (e)
                    if (i)
            ...
            buildFragment: function(t, e, i, n) {
                for (var s, o, a, r, l, h, c = e.createDocumentFragment(), u = [], d = 0, p = t.length; p > d; d++)
                    ...
                    for (o = o || c.appendChild(e.createElement("div")), a = (Nt.exec(s) || ["", ""])[1].toLowerCase(), r = Wt[a] || Wt._default, o.innerHTML = r[1] + s.replace(At, "<$1></$2>") + r[2], h = r[0]; h--;) o = o.lastChild;
            ...
            domManip: function(t, e) {
                ...
                if (h && (i = Z.buildFragment(t, this[0].ownerDocument, !1, this), n = i.firstChild, 1 === i.childNodes.length && (i = n), n)) {
                    for (s = Z.map(v(i, "script"), p), o = s.length; h > l; l++) a = i, l !== u && (a = Z.clone(a, !0, !0), o && Z.merge(s, v(a, "script"))), e.call(this[l], a, l);
                    if (o)
                        for (r = s[s.length - 1].ownerDocument, Z.map(s, f), l = 0; o > l; l++) a = s[l], Ot.test(a.type || "") && !vt.access(a, "globalEval") && Z.contains(r, a) && (a.src ? Z._evalUrl && Z._evalUrl(a.src) : Z.globalEval(a.textContent.replace(zt, "")))
                }
                return this
            }
        }), Z.each({
            ...
            Z.fn[t] = function(t) {
                for (var i, n = [], s = Z(t), o = s.length - 1, a = 0; o >= a; a++) i = a === o ? this : this.clone(!0), Z(s[a])[e](i), Y.apply(n, i.get());
        ...
        ! function() {
            ...
            a.style && (a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", G.clearCloneStyle = "content-box" === a.style.backgroundClip, o.style.cssText = "border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute", o.appendChild(a), t.getComputedStyle && Z.extend(G, {
            ...
            css: function(t, e) {
                return gt(this, function(t, e, i) {
                    var n, s, o = {},
                        a = 0;
                    if (Z.isArray(e)) {
                        for (n = qt(t), s = e.length; s > a; a++) o[e[a]] = Z.css(t, e[a], !1, n);
                        return o
                    }
        ...
        var Gt, Qt, Jt = /^(?:toggle|show|hide)$/,
            ...
            ie = {
                "*": [function(t, e) {
                    ...
                    if (a && a[3] !== o) {
                        o = o || a[3], s = s || [], a = +n || 1;
                        do r = r || ".5", a /= r, Z.style(i.elem, t, a + o); while (r !== (r = i.cur() / n) && 1 !== r && --l)
                    }
                ...
                finish: function(t) {
                    return t !== !1 && (t = t || "fx"), this.each(function() {
                        var e, i = vt.get(this),
                            ...
                            o = Z.timers,
                            a = n ? n.length : 0;
                        for (i.finish = !0, Z.queue(this, t, []), s && s.stop && s.stop.call(this, !0), e = o.length; e--;) o[e].elem === this && o[e].queue === t && (o[e].anim.stop(!0), o.splice(e, 1));
        ...
        Z.fn.extend({
            ...
            valHooks: {
                ...
                select: {
                    ...
                    set: function(t, e) {
                        for (var i, n, s = t.options, o = Z.makeArray(e), a = s.length; a--;) n = s[a], (n.selected = Z.inArray(n.value, o) >= 0) && (i = !0);
        ...
        Z.extend({
            ...
            ajax: function(t, e) {
                ...
                if (f.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, u.url = ((t || u.url || we) + "").replace(ue, "").replace(ge, xe[1] + "//"), u.type = e.method || e.type || u.method || u.type, u.dataTypes = Z.trim(u.dataType || "*").toLowerCase().match(pt) || [""], null == u.crossDomain && (l = ve.exec(u.url.toLowerCase()), u.crossDomain = !(!l || l[1] === xe[1] && l[2] === xe[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (xe[3] || ("http:" === xe[1] ? "80" : "443")))), u.data && u.processData && "string" != typeof u.data && (u.data = Z.param(u.data, u.traditional)), $(be, u, e, w), 2 === y) return w;
        ...
        t.attachEvent && t.attachEvent("onunload", function() {
            ...
            return G.cors || Ne && !t.crossDomain ? {
                send: function(i, n) {
                    ...
                    e = function(t) {
                        return function() {
                            e && (delete Ee[a], e = o.onload = o.onerror = null, "abort" === t ? o.abort() : "error" === t ? n(o.status, o.statusText) : n(Ae[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {
                                text: o.responseText
        ...
        Z.fn.load = function(t, e, i) {
            ...
            var n, s, o, a = this,
                r = t.indexOf(" ");
            return r >= 0 && (n = Z.trim(t.slice(r)), t = t.slice(0, r)), Z.isFunction(e) ? (i = e, e = void 0) : e && "object" == typeof e && (s = "POST"), a.length > 0 && Z.ajax({
                url: t,
                type: s,
                dataType: "html",
                data: e
        ...
        Z.offset = {
            ...
            offset: function(t) {
                ...
                var e, i, n = this[0],
                    ...
                    o = n && n.ownerDocument;
                return o ? (e = o.documentElement, Z.contains(e, n) ? (typeof n.getBoundingClientRect !== Dt && (s = n.getBoundingClientRect()), i = j(o), {
        ...
        t.extend(s.prototype, {
            ...
            _generateHTML: function(t) {
                ...
                for (t.drawMonth = Z, t.drawYear = tt, i = this._get(t, "prevText"), i = Y ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, Z - V, 1)), this._getFormatConfig(t)) : i, n = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "e" : "w") + "'>" + i + "</span></a>" : B ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "e" : "w") + "'>" + i + "</span></a>", s = this._get(t, "nextText"), s = Y ? this.formatDate(s, this._daylightSavingAdjust(new Date(tt, Z + V, 1)), this._getFormatConfig(t)) : s, o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "w" : "e") + "'>" + s + "</span></a>" : B ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (L ? "w" : "e") + "'>" + s + "</span></a>", a = this._get(t, "currentText"), r = this._get(t, "gotoCurrent") && t.currentDay ? G : j, a = Y ? this.formatDate(a, r, this._getFormatConfig(t)) : a, l = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", h = q ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (L ? l : "") + (this._isInRange(t, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + a + "</button>" : "") + (L ? "" : l) + "</div>" : "", c = parseInt(this._get(t, "firstDay"), 10), c = isNaN(c) ? 0 : c, u = this._get(t, "showWeek"), d = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), m = this._get(t, "monthNamesShort"), g = this._get(t, "beforeShowDay"), v = this._get(t, "showOtherMonths"), b = this._get(t, "selectOtherMonths"), y = this._getDefaultDate(t), _ = "", x = 0; U[0] > x; x++) {
                    for (C = "", this.maxRows = 4, k = 0; U[1] > k; k++) {
                        ...
                        for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + T + "'>" + (/all|left/.test(T) && 0 === x ? L ? o : n : "") + (/all|right/.test(T) && 0 === x ? L ? n : o : "") + this._generateMonthYearHeader(t, Z, tt, Q, J, x > 0 || k > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", S = u ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; 7 > w; w++) E = (w + c) % 7, S += "<th scope='col'" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[E] + "'>" + p[E] + "</span></th>";
        ...
        }, t.datepicker = new s, t.datepicker.initialized = !1, t.datepicker.uuid = (new Date).getTime(), t.datepicker.version = "1.11.1", t.datepicker, t.widget("ui.draggable", t.ui.mouse, {
            version: "1.11.1",
            ...
            drag: function(e, i, n) {
                ...
                for (d = n.snapElements.length - 1; d >= 0; d--) l = n.snapElements[d].left, h = l + n.snapElements[d].width, c = n.snapElements[d].top, u = c + n.snapElements[d].height, l - m > v || g > h + m || c - m > y || b > u + m || !t.contains(n.snapElements[d].item.ownerDocument, n.snapElements[d].item) ? (n.snapElements[d].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
                    snapItem: n.snapElements[d].item
                })), n.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (s = m >= Math.abs(c - y), o = m >= Math.abs(u - b), a = m >= Math.abs(l - v), r = m >= Math.abs(h - g), s && (i.position.top = n._convertPositionTo("relative", {
                    ...
                    top: 0,
                    left: h
                }).left - n.margins.left)), p = s || o || a || r, "outer" !== f.snapMode && (s = m >= Math.abs(c - b), o = m >= Math.abs(u - y), a = m >= Math.abs(l - g), r = m >= Math.abs(h - v), s && (i.position.top = n._convertPositionTo("relative", {
                    top: c,
                    left: 0
                }).top - n.margins.top), o && (i.position.top = n._convertPositionTo("relative", {
            ...
            function() {
                ...
                _refreshValue: function() {
                    ...
                    this.options.values && this.options.values.length ? this.handles.each(function(n) {
                        i = 100 * ((l.values(n) - l._valueMin()) / (l._valueMax() - l._valueMin())), c["horizontal" === l.orientation ? "left" : "bottom"] = i + "%", t(this).stop(1, 1)[h ? "animate" : "css"](c, r.animate), l.options.range === !0 && ("horizontal" === l.orientation ? (0 === n && l.range.stop(1, 1)[h ? "animate" : "css"]({
                            left: i + "%"
                    ...
                    }) : (n = this.value(), s = this._valueMin(), o = this._valueMax(), i = o !== s ? 100 * ((n - s) / (o - s)) : 0, c["horizontal" === this.orientation ? "left" : "bottom"] = i + "%", this.handle.stop(1, 1)[h ? "animate" : "css"](c, r.animate), "min" === a && "horizontal" === this.orientation && this.range.stop(1, 1)[h ? "animate" : "css"]({
                        width: i + "%"
        ...
        function i(n, s) {
            var o = [],
                ...
                r = 0;
            if (n.tag.isComment) s.allowComments && (o.push("<!--"), o.push(n.tag.rawAttributes), o.push(">"), s.format && e(n, s, o, r - 1));
            else {
                ...
                if (!n.isRoot && l && (o.push("<"), o.push(n.tag.name), t.each(n.attributes, function() {
                    ...
                    })), n.tag.isSelfClosing) l && o.push(" />"), a = !1;
                else if (n.tag.isNonClosing) a = !1;
                else {
                    if (!n.isRoot && l && o.push(">"), r = s.formatIndent++, n.tag.toProtect) p = t.htmlClean.trim(n.children.join("")).replace(/<br>/gi, "\n"), o.push(p), a = 0 == p.length;
                    else {
        ...
        function h(e) {
            for (; p(e) && e.children.length > 0;) e = e.children[0];
            if (!u(e)) return !1;
            var i = f(e);
        ...
        function c(e) {
            for (; p(e) && e.children.length > 0;) e = e.children[e.children.length - 1];
            if (!u(e)) return !1;
            var i = f(e);
        ...
        t.fn.htmlClean = function(e) {
            ...
            for (var g; h = c.exec(e);) {
                ...
                if (g = c.lastIndex, v.isClosing) n(f, [v.name]) && (f.pop(), m = f[f.length - 1]);
                else {
                    for (var w, x = new a(v); w = d.exec(v.rawAttributes);) {
                        if ("style" == w[1].toLowerCase() && o.replaceStyles)
                            for (var C = !v.isInline, k = 0; k < o.replaceStyles.length; k++) o.replaceStyles[k][0].test(w[2]) && (C || (v.render = !1, C = !0), m.children.push(x), f.push(x), m = x, v = new l(o.replaceStyles[k][1], "", "", o), x = new a(v));
                    ...
                    if (m.isRoot || (m.tag.isInline && !v.isInline ? (S = s(f)) && (m = f[f.length - 1]) : m.tag.disallowNest && v.disallowNest && !v.requiredParent ? S = !1 : v.requiredParent && (S = n(f, v.requiredParent)) && (m = f[f.length - 1])), S)
                        if (m.children.push(x), v.toProtect)
                            ...
                            } else v.isSelfClosing || v.isNonClosing || (f.push(x), m = x)
                }
            }
...
$(window).resize(function() {
    ...
    $("body").css("min-height", $(window).height() - 90), $(".demo").css("min-height", $(window).height() - 160), $(".demo, .demo .column").sortable({
        connectWith: ".column",
        opacity: .35,
        handle: ".drag"
